...
class ActivityRecordController extends Controller
{
    public function onlineUsers()
    {
        ...
        $activeUsers = ActivityRecord::where('activity_status', 1)->with('user')->get()->pluck('user')->paginate(6);
    ...
    {
        $inactiveUsers = ActivityRecord::where('activity_status', 0)->with('user')->get()->pluck('user')->paginate(6);
